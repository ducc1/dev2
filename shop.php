<?
	...
	$shop_cate_arr = Array(
		...
		//"tsell_list"=>array("판매 내역"=>array("tsell_list","tsell_list_view")),
		//"tmoney_list"=>array("정산 내역"=>array("tmoney_list","tmoney_view")),
		"goods_list"=>array("상품정보"=>array("oods_list","goods_write","goods_view")),
		"option_goods_list"=>array("옵션상품정보"=>array("option_goods_list","option_goods_write","option_goods_view")),
		//"shop_member_list"=>array("담당자관리"=>array("shop_member_list","shop_member_write")),
		"order_list"=>array("주문관리"=>array("order_list","order_view")),
		//"tpay_list"=>array("충전/사용내역"=>array("tpay_list")),
		//"notice_list"=>array("샵공지사항"=>array("notice_list","notice_view")),
		//"img_list"=>array("샵갤러리"=>array("img_list","img_write")),
		//"qa_list"=>array("상점상담"=>array("qa_list","qa_write")),
		"review_list"=>array("리뷰관리"=>array("review_list","review_write")),
	);
	
	$answer_arr = Array("1"=>"답변대기","2"=>"답변완료");
	$singo_arr = Array("1"=>"광고/홍보성" , "2"=>"욕설/인신공격" , "3"=>"불법정보" , "4"=>"개인정보침해" , "5"=>"음산/선정성" , "6"=>"권리침해신고");
