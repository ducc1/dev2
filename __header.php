...
<head>
    ...
    <!-- CORE CSS-->    
    <link href="/gadm/asset/css/materialize.css" type="text/css" rel="stylesheet" media="screen,projection">
    <link href="/gadm/asset/css/style.css" type="text/css" rel="stylesheet" media="screen,projection">
    <!-- Custome CSS-->    
    <link href="/gadm/asset/css/custom/custom.css" type="text/css" rel="stylesheet" media="screen,projection">


    <!-- INCLUDED PLUGIN CSS ON THIS PAGE -->
    <link href="/gadm/asset/js/plugins/perfect-scrollbar/perfect-scrollbar.css" type="text/css" rel="stylesheet" media="screen,projection">
    <link href="/gadm/asset/js/plugins/jvectormap/jquery-jvectormap.css" type="text/css" rel="stylesheet" media="screen,projection">
    <link href="/gadm/asset/js/plugins/chartist-js/chartist.min.css" type="text/css" rel="stylesheet" media="screen,projection">
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.html" class="brand-logo darken-1"><img src="/gadm/asset/images/materialize-logo.png" alt="materialize logo"></a> <span class="logo-text">Materialize</span></h1></li>
                    </ul>
                    <!--
            ...
            <aside id="left-sidebar-nav">
                ...
                <div class="row">
					...
					<div class="col col s4 m4 l4">
						...
						<!--<a><i class="mdi-action-account-box large icon-demo"></i></a>--><img src="images/admin3.png" alt="" class="circle responsive-img valign profile-image">
                    </div>
                    ...
                    <div class="col col s8 m8 l8">
                        ...
                        <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown"><?=$_SESSION['nick']?><i class="mdi-navigation-arrow-drop-down right"></i></a>
                        <p class="user-roal">Administrator</p>
                    </div>
                </div>
                </li>
                <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> 홈</a>
                </li>
				...
				<?php
					...
					foreach($admin_menu_arr as $m_key=>$m_val){
						...
						if(is_array($m_val)){
							...
							if(is_array($m_val2)) $var_css = "no-padding";
							else $var_css = "bold";
							
							$left_menu  .= "<li class=\"". $var_css  ."\">".PHP_EOL;

					
								if(!is_array($m_val2)){
									$left_menu  .=  "<a href=\"".$m_key.".php?doc=".$m_val2."\" class=\"waves-effect waves-cyan\"><i class=\"mdi-communication-email\"></i> ".$m_key2." </a>".PHP_EOL;;	
								}else{
									$left_menu  .= " <ul class=\"collapsible collapsible-accordion\">".PHP_EOL;
									$left_menu  .=  "		<li class=\"bold\"><a class=\"collapsible-header waves-effect waves-cyan\"><i class=\"mdi-action-view-carousel\"></i> ".$m_key2."</a>".PHP_EOL;
									$left_menu  .=  "			<div class=\"collapsible-body\">".PHP_EOL;
									$left_menu .=   "				<ul>";
								}
								...
								if(is_array($m_val2)){
										...
										foreach($m_val2 as $m_key3=>$m_val3){
											...
											if($_REQUEST['doc'] == $m_key3 && $m_key == $doc_name) $css2 = "color:#49AEF2;";
													...
													$left_menu .=   "<li><a href=\"".$m_key.".php?doc=".$m_key3."\">".$m_val3."</a>".PHP_EOL;;
										}
								...
								if(!is_array($m_val2)){
									...
									$left_menu .=  "			</ul>".PHP_EOL;
									$left_menu .=  "		</div>".PHP_EOL;
									$left_menu .=  "</ul>".PHP_EOL;
								}

							$left_menu .= "</li>".PHP_EOL;
							}
						}	
					}
					?>
